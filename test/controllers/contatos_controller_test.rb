...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { email: @contato.email, nome: @contato.nome, telefone: @contato.telefone } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { email: @contato.email, nome: @contato.nome, telefone: @contato.telefone } }
